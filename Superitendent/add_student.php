...
<?php
	...
	<?php
        ...
        mysqli_query($conn,"INSERT INTO tblemployees(FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,swift_hostel,role,Phonenumber,Status, location) VALUES('$fname','$lname','$email','$password','$gender','$dob','$department','$address','$maintenance_request_limit','$user_role','$phonenumber','$status', 'NO-IMAGE-AVAILABLE.jpg')         
		") or die(mysqli_error()); ?>
...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="../vendors/images/oursystemlogo1.png" alt=""></div>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Add Engineer Details</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Engineer Form</h4>
							<p class="mb-20"></p>
						</div>
					</div>
								...
								<div class="row">
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="maintenance_request_limit" type="number" class="form-control" required="true" autocomplete="off">
										</div>
									</div>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<select name="user_role" class="custom-select form-control" required="true" autocomplete="off">
												<option value="Admin">Resident Engineer</option>
												<option value="HOD">Key Custodian</option>
												<option value="Student">Student</option>
												<option value="Staff">Staff</option>
												<option value="HeadOfDepartment">Head of Department</option>
												<option value="Superitendent">Superitendent</option>
												<option value="LevelRep">Level Rep</option>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-primary" name="add_student" id="add_student" data-toggle="modal">Add&nbsp;Engineer</button>
											</div>
										</div>
									</div>
								</div>
