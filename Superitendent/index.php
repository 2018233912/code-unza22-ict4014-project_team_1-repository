					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								<?php $sql = "SELECT requests.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.emp_id,requests.requestType,requests.PostingDate,requests.Status from requests join tblemployees on requests.empid=tblemployees.emp_id where tblemployees.role = 'Student' and Department = '$session_depart' order by lid desc limit 5";
									$query = $dbh -> prepare($sql);
									$query->execute();
									$results=$query->fetchAll(PDO::FETCH_OBJ);
									$cnt=1;
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											<a class="dropdown-item" href="maintenance_details.php?requestid=<?php echo htmlentities($result->lid);?>"><i class="dw dw-eye"></i> View</a>
