...
<?php
	...
	{ 
		...
		$status=$_POST['status'];   
		$swift_hostel=$_POST['swift_hostel'];
		$num_days=$_POST['num_days'];

		// $REMMAINTENANCE = $swift_hostel - $num_days;
		$reg_remarks = 'request was Rejected. Registra/Registry will not see it';
		$reg_status = 2;
		date_default_timezone_set('Asia/Kolkata');
		$admremarkdate=date('Y-m-d G:i:s ', strtotime("now"));

		if ($status === '2') {
			$result = mysqli_query($conn,"update requests, tblemployees set requests.AdminRemark='$description',requests.Status='$status',requests.AdminRemarkDate='$admremarkdate', requests.registra_remarks = '$reg_remarks', requests.admin_status = '$reg_status' where requests.empid = tblemployees.emp_id AND requests.id='$did'");
		...
		elseif ($status === '1') {
				$result = mysqli_query($conn,"update requests, tblemployees set requests.AdminRemark='$description',requests.Status='$status',requests.AdminRemarkDate='$admremarkdate' where requests.empid = tblemployees.emp_id AND requests.id='$did'");

				if ($result) {
			     	echo "<script>alert('Request Maintenance Approved Successfully');</script>";
					} else{
					  die(mysqli_error());
				   }
		}
		...
		// $sql="update requests set AdminRemark=:description,Status=:status,AdminRemarkDate=:admremarkdate where id=:did";
...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="../vendors/images/ourlogo.png" alt=""></div>
		...
		<div class="pd-ltr-20">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Maintenance Details</h4>
							<p class="mb-20"></p>
						</div>
					</div>
					<form method="post" action="">
						...
						$sql = "SELECT requests.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.emp_id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.EmailId,tblemployees.swift_hostel,requests.requestType,requests.ToDate,requests.FromDate,requests.Description,requests.PostingDate,requests.Status,requests.AdminRemark,requests.admin_status,requests.registra_remarks,requests.AdminRemarkDate,requests.num_days from requests join tblemployees on requests.empid=tblemployees.emp_id where requests.id=:lid";
						$query = $dbh -> prepare($sql);
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Request Date</b></label>
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Working Days</b></label>
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>No. of Days Remaining</b></label>
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly name="swift_hostel" value="<?php echo htmlentities($result->swift_hostel);?>">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>Issue Fixing Due Date</b></label>
						...
						<div class="form-group row">
								<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Nature of Maintenance Issue</b></label>
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label style="font-size:16px;"><b>Resident Engineer Status</b></label>
							...
							if(($stats==0 AND $ad_stats==0) OR ($stats==2 AND $ad_stats==0) OR ($stats==2 AND $ad_stats==2))
							 ...
							 ?>
							  <div id="center_button">
									...
									transition: all 0.5s;
									cursor: pointer;
									margin: 5px;" onclick="location.href='../upload_image/index.php'">View image of Issue</button>
								</div>
							<div class="col-md-3">
								<div class="form-group">
									...
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											<div class="modal-body text-center font-18">
												<h4 class="mb-20">action taken</h4>
