...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="../vendors/images/banner-img.png" alt=""></div>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">System User Form</h4>
							<p class="mb-20"></p>
						</div>
					</div>
						...
						<form method="post" action="">
							<section>
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label >Hostel and Room Number :</label>
								...
								<div class="row">
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="yearofstudy" type="text" class="form-control" required="true" autocomplete="off">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Student Accomodation Period :</label>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<option value="Admin">Admin</option>
												...
												<option value="level_rep">Level Rep</option>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-primary" name="add_student" id="add_student" data-toggle="modal">add&nbsp;user</button>
											</div>
										</div>
									</div>
								</div>
