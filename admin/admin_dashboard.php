		...
		<div class="pd-ltr-20">
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					<div class="col-md-4 user-icon">
						<img src="../vendors/images/oursystemlogo.png" heigth = '400' width = '200' alt="">
					</div>
					<div class="col-md-8">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between">
							<div class="h5 mb-0">Member Area</div>
							<div class="table-actions">
								<a title="VIEW" href="student.php"><i class="icon-copy ion-disc" data-color="#17a2b8"></i></a>	
							</div>
						</div>
					...
					<table class="data-table table stripe hover nowrap">
						<thead>
							<tr>
								...
								<th>RE. STATUS</th>
								<th class="datatable-nosort">Accomodation Period</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<?php 
								$status=1;
								$sql = "SELECT requests.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.location,tblemployees.emp_id,requests.requestType,requests.PostingDate,requests.Status, requests.admin_status from requests join tblemployees on requests.empid=tblemployees.emp_id where requests.Status= '$status' order by lid desc limit 5";
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											<a class="dropdown-item" href="maintenance_details.php?requestid=<?php echo $row['lid']; ?>"><i class="dw dw-eye"></i> View</a>
