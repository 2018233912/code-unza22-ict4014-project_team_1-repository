 ...
 if(isset($_POST['edit']))
{
    ...
    $result = mysqli_query($conn,"update requestType set requestType='$requestType', Description='$description', date_from='$dtefrom', date_to='$dteto' where id = '$get_id' ");
    if ($result) {
							...
							<div class="col-md-6 col-sm-12">
								...
								<nav aria-label="breadcrumb" role="navigation">
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">Edit Request Type</li>
									</ol>
								</nav>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								...
								<section>
									<?php
									$query = mysqli_query($conn,"SELECT * from requestType where id = '$get_id'")or die(mysqli_error());
