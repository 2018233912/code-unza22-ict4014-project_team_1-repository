...
<?php
	...
	$result = mysqli_query($conn,"update tblemployees set FirstName='$fname', LastName='$lname', EmailId='$email', Gender='$gender', Dob='$dob', Department='$department', Address='$address', swift_hostel='$maintenance_request_limit', role='$user_role', Phonenumber='$phonenumber' where emp_id='$get_id'         
		"); 		
	if ($result) {
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Edit Studentf</h4>
							<p class="mb-20"></p>
						</div>
					</div>
								...
								<div class="row">
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="maintenance_request_limit" type="text" class="form-control" required="true" autocomplete="off"value="<?php echo $new_row['swift_hostel']; ?>">
										</div>
									</div>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<select name="user_role" class="custom-select form-control" required="true" autocomplete="off">
												...
												<option value="Resident Engineer">Student</option>
												<option value="Superitendent">Student</option>
												<option value="Level Rep">Student</option>
