...
<?php
	...
	{ 
		...
		if ($status === '2') {
			$sql="update requests set registra_remarks=:description,admin_status=:status,AdminRemarkDate=:admremarkdate where id=:did";
			...
			$query->bindParam(':did',$did,PDO::PARAM_STR);
			$query->execute();
			echo "<script>alert('Maintenance Request Approved Successfully');</script>";
		}
		elseif ($status === '1') {
				$result = mysqli_query($conn,"update requests, tblemployees set requests.registra_remarks='$description',requests.admin_status='$status',requests.AdminRemarkDate='$admremarkdate', tblemployees.swift_hostel='$REMMAINTENANCE' where requests.empid = tblemployees.emp_id AND requests.id='$did'");
...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="../vendors/images/oursystemlogo.png" alt=""></div>
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Request Duration</b></label>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>Maintenance Period</b></label>
						...
						<div class="form-group row">
								<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Maintenance Reason</b></label>
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label style="font-size:16px;"><b>Maintenance Status From HOD</b></label>
									...
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											<div class="modal-body text-center font-18">
												<h4 class="mb-20">Maintenance take action</h4>
