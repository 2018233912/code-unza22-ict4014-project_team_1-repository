							...
							<div class="profile-tab height-100-p">
								<div class="tab height-100-p">
									<ul class="nav nav-tabs customtab" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" data-toggle="tab" href="#timeline" role="tab">Maintenance Records</a>
										</li>
										<li class="nav-item">
										...
										<div class="tab-pane fade show active" id="timeline" role="tabpanel">
											<div class="pd-20">
												<div class="profile-timeline">
													<?php $query= mysqli_query($conn,"SELECT * from requests where empid = '$session_id'")or die(mysqli_error());
												...
												<form method="POST" enctype="multipart/form-data">
													<div class="profile-edit-list row">
														...
														<div class="weight-500 col-md-6">
															...
															?>
															<div class="form-group">
																<label>Available maintenance Days</label>
																<input class="form-control form-control-lg" type="text" required="true" autocomplete="off" readonly value="<?php echo $row['swift_hostel']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
