...
<?php 
	 if (isset($_GET['delete'])) {
		...
		$sql = "DELETE FROM requestType where id = ".$request_type_id;
 ...
 if(isset($_POST['add']))
{
     ...
     $query = mysqli_query($conn,"select * from requestType where requestType = '$requestType'")or die(mysqli_error());
     ...
     if ($count > 0){ 
        ...
        $query = mysqli_query($conn,"insert into requestType (requestType, Description, date_from, date_to)
					...
					<div class="page-header">
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="title">
									<h4>Maintenance Type List</h4>
								</div>
								<nav aria-label="breadcrumb" role="navigation">
									<ol class="breadcrumb">
										<li class="breadcrumb-item"><a href="admin_dashboard.php">Dashboard</a></li>
										<li class="breadcrumb-item active" aria-current="page">Maintenance Type Module</li>
									</ol>
								</nav>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								<h2 class="mb-30 h4">New Maintenance Type</h2>
								<section>
						...
						<div class="col-lg-8 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								<h2 class="mb-30 h4">Maintenance Request Type List</h2>
								<div class="pb-20">
									<table class="data-table table stripe hover nowrap">
										<thead>
										<tr>
											<th class="table-plus">MAINTENANCE TYPE</th>
										...
										<tbody>
											...
											<?php $sql = "SELECT * from requestType";
