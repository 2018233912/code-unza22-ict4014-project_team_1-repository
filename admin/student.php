			...
			<div class="row pb-10">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Total System Users</div>
							</div>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_student = mysqli_query($conn,"select * from tblemployees where role = 'level_rep' ")or die(mysqli_error());
						 $count_reg_student = mysqli_num_rows($query_reg_student);
						 ?>
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo htmlentities($count_reg_student); ?></div>
								<div class="font-14 text-secondary weight-500">Level Reps</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#09cc06"><span class="icon-copy fa fa-hourglass"></span></div>
							</div>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_student = mysqli_query($conn,"select * from tblemployees where role = 'Staff' ")or die(mysqli_error());
						 $count_reg_student = mysqli_num_rows($query_reg_student);
						 ?>
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo htmlentities($count_reg_student); ?></div>
								<div class="font-14 text-secondary weight-500">Members of Staff</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#09cc06"><span class="icon-copy fa fa-hourglass"></span></div>
							</div>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_student = mysqli_query($conn,"select * from tblemployees where role = 'Key_custodian' ")or die(mysqli_error());
						 $count_reg_student = mysqli_num_rows($query_reg_student);
						 ?>
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo htmlentities($count_reg_student); ?></div>
								<div class="font-14 text-secondary weight-500">Key Custodians</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#09cc06"><span class="icon-copy fa fa-hourglass"></span></div>
							</div>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_student = mysqli_query($conn,"select * from tblemployees where role = 'superitendent' ")or die(mysqli_error());
						 $count_reg_student = mysqli_num_rows($query_reg_student);
						 ?>
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo htmlentities($count_reg_student); ?></div>
								<div class="font-14 text-secondary weight-500">R.E Departmentss</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#09cc06"><span class="icon-copy fa fa-hourglass"></span></div>
							</div>
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								<td><?php echo $row['swift_hostel']; ?></td>
								<td>
									<div class="dropdown">
